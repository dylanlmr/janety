...
<div
	class="container mx-auto flex h-dvh flex-col bg-background p-4 text-foreground transition-colors duration-300"
>
	<div class="flex flex-row justify-center">
		<h1 class="text-center text-4xl font-bold">Janety</h1>
	...
	<div class="flex h-full flex-1 flex-col gap-4 md:flex-row">
		<div class="flex flex-col md:flex-1">
			<Label for="janety-editor" class="mb-2 block shrink-0 text-xl">Janety</Label>
		...
		<div class="flex flex-col md:flex-1">
			<Label for="janet-editor" class="mb-2 block shrink-0 text-xl">Janet</Label>
